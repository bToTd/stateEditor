...
export default {
  ...
  methods:{
    init() {
      ...
      this.myDiagram =
        $(go.Diagram, "myStateGp",  // must name or refer to the DIV HTML element
          {
    ...
    save() {
      this.stateModel = myDiagram.model.toJson();
    },
    load() {
      this.myDiagram.model = go.Model.fromJson(this.stateModel);
    }
  }
}
</script>
